...
while True:
    if countar == 0:
        sg.popup('Teste.....',title='Teste', button_type=POPUP_BUTTONS_NO_BUTTONS, no_titlebar=True, auto_close=True, auto_close_duration=5)
        for i in range(1000):
            
            sg.PopupAnimated(image_source=DEFAULT_BASE64_LOADING_GIF, time_between_frames=100,background_color='yellow',message='Teste')
            #sg.time.sleep(3)

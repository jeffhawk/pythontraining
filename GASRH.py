...
class Telas_Sys:
    ...
    def tela_cad_user(self):
            ...
            btn_Cad_User = Button(Frame_Btn_Cad_user, text='Cadastrar', command=lambda: Bd.cadastrar_user(self.txt_Nome_User.get(), self.txt_Senha_User.get()), fg='blue', font=fonte_Normal)
            #btn_Entrar.bind('<Button-1>', logar)
    ...
    def tela_cad_func():
        ...
        Telas_Sys.centralizar_window(Tela_Cadastro_Func)
        ...
        if txt_Nome_Func.get() == "" or txt_Setor_Func.get() == "" or txt_SalB_Func.get() == "" or txt_Bonus_Func.get() == "" or txt_Meses_Func.get() == "" or txt_Dias_Func.get() == "":
            ...
            Tela_Cadastro_Func.lift()
            txt_Nome_Func.focus()
        btn_Cad_Func = Button(Frame_Btn_Cad_func, text='Cadastrar', command=lambda: Bd.cadastrar_func(txt_Nome_Func.get(), txt_Setor_Func.get(), txt_SalB_Func.get(), txt_Bonus_Func.get(), txt_Meses_Func.get(), txt_Dias_Func.get(), txt_Dep_Func.get()), fg='blue', font=fonte_Normal)
        #btn_Entrar.bind('<Button-1>', logar)
...
Telas_Sys.tela_splash(Telas_Sys)
Telas_Sys.Splash_Screen.after(2000, Telas_Sys.tela_login(Telas_Sys))
